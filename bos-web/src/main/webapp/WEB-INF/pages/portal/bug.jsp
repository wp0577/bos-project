...
<br />
<div style="margin-top:8px;"><a href="javascript:void(0);" onclick="$('#bug_form').submit();" id="bug_form_but" class="easyui-linkbutton">sumbit</a></div>
</form>
</div>
<script>
//功能相对独立，应该单独放置
$('#bug_form').form({  
	url:"userAction_sumbitBug",
	onSubmit: function(){  
		if($('#bug_c').val()==""){
	...
	success:function(data){  
		$.messager.alert('Warning',"Submit Succeed");
		$('#bug_c').val("");
	}  
});   
</script>